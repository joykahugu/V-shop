 ...
 function createElement(tag, className, text) {
  ...
  function renderProducts () {
     ...
     products.forEach(product => {
      let productDiv = document.createElement("div", "product-card grid grid-rows-4 grid-cols-3 bg-white rounded-lg shadow-md overflow-hidden text-center");
      ...
      let addButton = document.createElement('button', 'add-to-cart-btn mt-4 w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-700', 'Add To Cart');
  ...
  function renderCart() {
    ...
    if (cart.length === 0) {
        ...
        cart.forEach(item => {
            ...
            const cartDiv2 = createElement('div', 'flex items-center gap-2');
